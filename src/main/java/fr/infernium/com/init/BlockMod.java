...
public class BlockMod
{
    ...
    {
        platine_ore = new BlockBase(Material.rock, 3).setBlockName("platine_ore").setBlockTextureName(Reference.MOD_ID + ":platine_ore").setCreativeTab(CreativeTabs.tabMisc).setHardness(4.0f).setResistance(30.0f);
        ...
        nitronium_ore = new BlockBase(Material.rock, 3).setBlockName("nitronium_ore").setBlockTextureName(Reference.MOD_ID + ":nitronium_ore").setCreativeTab(CreativeTabs.tabMisc).setHardness(4.0f).setResistance(30.0f);
